...
- **AI Categorization** — LLM assigns/corrects categories in bulk (issue #18)
- **Anomaly Detection** — statistical + LLM-explained unusual transactions (issue #19)
- **AI Monthly Insights** — streaming narrative summaries per month (issue #20)
- **AI Advisor chat** — conversational financial advisor with 6 tools (issue #21)
